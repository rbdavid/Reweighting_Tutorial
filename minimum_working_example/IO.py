...
def config_parser(config_file,parameters):	# Function to take config file and create/fill the parameter dictionary 
    ...
    necessary_parameters = ['emus_meta_file','num_biased_dimensions','temperature','k_B','unbiased_data_files_naming','nWindows','xMin','xMax','xBins','x_axis_label','reweighted_x_axis_prob_density_plot_name','reweighted_x_axis_unstitched_fe_plot_name','reweighted_x_axis_stitched_fe_plot_name','reweighted_x_axis_stitched_fe_plot_name']

    all_parameters       = ['emus_meta_file','num_biased_dimensions','temperature','k_B','unbiased_data_files_naming','nWindows','xMin','xMax','xBins','x_axis_label','reweighted_x_axis_prob_density_plot_name','reweighted_x_axis_unstitched_fe_plot_name','reweighted_x_axis_stitched_fe_plot_name','reweighted_x_axis_stitched_fe_plot_name','bootstrap_bool','nIterations']
